...
INSERT INTO Vendedor (vend_nome,vend_sobrenome,vend_sexo,vend_salario,vend_vendidos,vend_admissao,Loja_fk)
VALUES ('Lucas','Silva e Silva','M',2000,1,'10-22-2013',07);
INSERT INTO Vendedor (vend_nome,vend_sobrenome,vend_sexo,vend_salario,vend_vendidos,vend_admissao,Loja_fk)
VALUES ('Mario','Carneiro Pedregulho','M',2200,2,'02-01-2011',55);
INSERT INTO Vendedor (vend_nome,vend_sobrenome,vend_sexo,vend_salario,vend_vendidos,vend_admissao,Loja_fk)
VALUES ('Marina','Chaves Bim','F',3400,16,'08-30-2012',07);
INSERT INTO Vendedor (vend_nome,vend_sobrenome,vend_sexo,vend_salario,vend_vendidos,vend_admissao,Loja_fk)
VALUES ('Cacilda','Flavia Moreno','F',1400,0,'12-28-2015',99);

INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Claudio','Gilberto Santos','11-09-1990','m',35498769846,19564688,357098504,78);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Maria','Hortela Carla Milda','11-04-1981','f',36597452146,1923356548,13055698,55);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Amelia','Gilba Junk','10-09-1970','f',32698564875,1999995745,65325698,258);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Claudia','Harrison Ford','03-09-1984','f',64573820956,1132699658,65874512,666);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Francisca','Helena Marques','04-09-1994','f',84569530548,1398854682,245987524,01);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Joaquim,','Junior Filho Neto','07-09-1976','m',956832609886,14659896,34678465,678);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Augusto','Garoto Fru','11-04-1990','m',41387456993,19986593,16798740,77789);
INSERT INTO Cliente(nome,sobrenome,nasc,sexo,cpf,fone,cep,nr)
VALUES ('Victor','Silva Peres','01-09-1990','m',21695303669,1132659974,14659896,6458);

/* INSERÇÃO DE VALORES 2, EXECUTA A TRIGGER, EXECUTAR EM quinto */


INSERT INTO Venda(carro_fk,loja_fk,venda_data,cliente_fk,vendedor_fk)
VALUES (7,13,'12-05-2010',5,5)
INSERT INTO Venda(carro_fk,loja_fk,venda_data,cliente_fk,vendedor_fk)
VALUES (1,55,'06-05-2013',1,2)
INSERT INTO Venda(carro_fk,loja_fk,venda_data,cliente_fk,vendedor_fk)
VALUES (3,01,'05-04-2012',2,1)
INSERT INTO Venda(carro_fk,loja_fk,venda_data,cliente_fk,vendedor_fk)
VALUES (5,07,'11-07-2011',4,3)
INSERT INTO Venda(carro_fk,loja_fk,venda_data,cliente_fk,vendedor_fk)
VALUES (8,99,'02-12-2014',3,4)


/* COMANDOS DE SELEÇÃO -- EXECUTAR EM sexto */
